...
searchBtn.addEventListener('clikc' , searchUser) ;
...
//API = // https://api.github.com/users/czboukada-gif
...
function displayUserData(user) {
  ...
  bioElement.textContent = user.bio || 'No bio avalaible.' ;

  locationElement.textContent = formatDate(user.created_at) ;
...
searchInput.value = 'czboukada-gif'
searchUser() ;